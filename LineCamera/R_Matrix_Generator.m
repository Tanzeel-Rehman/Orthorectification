...
%Rotation in ZXY order
r11 = cos(phi)*cos(kappa);
r12 = -cos(omega)*sin(kappa)+ sin(omega)*sin(phi)*cos(kappa);
r13 = sin(omega)*sin(kappa) + cos(omega)*sin(phi)* cos(kappa);
r21 = cos(phi)*sin(kappa);
r22 = cos(omega)*cos(kappa)+ sin(omega)*sin(phi)*sin(kappa);
r23 = -sin(omega)*cos(kappa) + cos(omega)*sin(phi)* sin(kappa);
r31 = -sin(phi);
r32 = sin(omega)* cos(phi);
r33 = cos(omega)*cos(phi);
